...
public:
    ...
    std::vector<landmark_vertex*> create_vertices(data::marker* mkr, const bool is_constant);

    //! Get vertex corresponding with the specified marker
    landmark_vertex* get_vertex(data::marker* mkr, const unsigned int corner_id) const;
...
inline std::vector<landmark_vertex*> marker_vertex_container::create_vertices(data::marker* mkr, const bool is_constant) {
...
inline landmark_vertex* marker_vertex_container::get_vertex(data::marker* mkr, const unsigned int corner_id) const {
